...
<template>
  <DropdownMenu>
    <DropdownMenuTrigger as-child>
      <Button variant="outline" class="cursor-pointer shadow-md inset-shadow-black/50 size-12 sm:size-12 md:size-12 py-1 active:brightness-90 hover:brightness-95 duration-300">
