    ...
    <div class="flex flex-col p-4 md:p-6 lg:p-8 w-full md:w-5/6">
      <div class="md:p-10">
        ...
        <div class="grid grid-cols-1 gap-6">
          <div
            class="w-full outline-1 dark:outline-gray-200/10 dark:bg-[#1e1e1e]/10 bg-[#e8e8e8]/10 rounded-2xl p-5"
          >
            <Table>
              <TableHeader>
                <TableRow class="hover:bg-transparent">
                  <TableHead class="lg:text-2xl font-bold text-foreground"
                    >Personal Information</TableHead
                  >
                  <TableHead
                    v-if="!manage"
                  ...
                  >
                    <Button
                      ...
                      >Cancel</Button
                    >
                    <Button @click="handleSave" class="cursor-pointer">Save</Button>
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow class="hover:bg-transparent">
                  <TableCell class="h-[6vh] text-foreground lg:px-10 lg:h-[8vh]"
                    >Username</TableCell
                  >
                  <TableCell
                    :class="
                      manage
                        ? 'text-foreground text-right lg:px-10 lg:h-[8vh]'
                        : 'text-[#3A3A3A] text-right lg:px-10'
                    "
                  >
                    <input
                      :disabled="!manage"
                ...
                <TableRow class="hover:bg-transparent">
                  ...
                  <TableCell
                    :class="
                      manage
                        ? 'text-foreground text-right lg:px-10'
                        : 'text-[#3A3A3A] text-right lg:px-10'
                    "
                  >
                    <Popover v-if="manage">
                ...
                <TableRow class="hover:bg-transparent">
                  ...
                  >
                    <Button
                      ...
                      >Cancel</Button
                    >
                    <Button @click="handlePasswordSave" class="cursor-pointer">Save</Button>
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow class="hover:bg-transparent">
                  <TableCell class="h-[6vh] text-foreground lg:px-10 lg:h-[6vh]"
                    >Password</TableCell
                  >
                  <TableCell
                    :class="
                      update
                        ? 'text-foreground text-right lg:px-10 lg:h-[6vh] flex justify-end'
                        : 'text-[#3A3A3A] text-right lg:px-10 lg:h-[6vh]'
                    "
                  >
                    <span class="text-gray-400" v-if="!update">*********</span>
                    <div
                      v-else
                      class="flex justify-end items-center px-2 w-full sm:w-full md:w-full lg:w-3/5 shadow-none focus:outline-none border rounded-lg h-full bg-popover text-popover-foreground"
                    >
                      <input
