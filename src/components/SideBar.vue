...
import { Triangle, House, UsersRound, Files, MessageSquareText, Logs, Bell, UserRound, Settings, LogOut, Loader2, Sun, Moon, Palette } from 'lucide-vue-next';
...
<template>
  <Sidebar v-if="route.path !== '/forgot-password' && route.path !== '/' && route.path !== '/dashboard'"
    v-model:open="isSidebarOpen" class="flex flex-col h-screen w-1/6">
    <SidebarHeader>
            ...
            <div class="flex flex-col gap-2">
              ...
              <HoverCard v-model:open="hoverOpen">
                <HoverCardTrigger as-child>
                  <Button class="flex gap-2 justify-start bg-transparent font-normal focus-visible:ring-0 text-[#E7E7E7] dark:hover:text-background">
                ...
                <HoverCardContent side="right" class="w-40 p-2 ml-2 bg-[#242629] dark:bg-[#121210]">
                  <div class="flex flex-col gap-2">
                    <Button @click="setMode('light')" class="flex gap-2 justify-start bg-transparent font-normal text-[#E7E7E7] dark:hover:text-background">
                      <Sun class="size-5" />
                      <span>Light</span>
                    </Button>
                    <Button @click="setMode('dark')" class="flex gap-2 justify-start bg-transparent font-normal text-[#E7E7E7] dark:hover:text-background">
                      <Moon class="size-5" />
                      <span>Dark</span>
                    </Button>
                    <Button @click="setMode('auto')" class="flex gap-2 justify-start bg-transparent font-normal text-[#E7E7E7] dark:hover:text-background">
                      <Palette class="size-5" />
                      <span>System</span>
                    </Button>
                  </div>
              ...
              <Button @click="doLogout" :disabled="auth.isLoading"
                class="flex gap-2 justify-start bg-transparent font-normal focus-visible:ring-0 text-[#E7E7E7] dark:hover:text-background">
