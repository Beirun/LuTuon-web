...
<template>
  ...
  <DropdownMenu v-model:open="notifOpen">
    ...
    <DropdownMenuContent align="center" class="w-80 max-h-96 overflow-y-auto">
      ...
      <div v-else-if="notification.notifications.length === 0" class="p-4 text-center py-20 text-muted-foreground text-lg">
        No notifications
      </div>
      <div v-else>
        <DropdownMenuItem
        ...
        >
          <span class="font-medium"
            :class="n.notificationStatus !== 'read' ? 'text-foreground' : 'text-muted-foreground'">
            {{ n.notificationTitle }}
          </span>
            ...
            <div v-if="activeItem !== 'security'" class="w-full border border-border rounded-xl">
              <div class="flex justify-between border-b p-3 items-center">
                ...
                <div v-if="edit" class="flex gap-5">
                  ...
                  <Button :disabled="auth.isLoading" @click="handleSave"
            ...
            <div class="w-full border border-border rounded-xl">
              <div class="flex justify-between border-b p-3 items-center">
                ...
                <div v-if="managePasswordEdit" class="flex gap-5">
                  ...
                  <Button :disabled="auth.isLoading" @click="handlePasswordSave"
                    class="bg-transparent p-0 hover:bg-transparent cursor-pointer shadow-none text-[#F8C600]">
                    Save
                  </Button>
                </div>
                    ...
                    <TableRow class="flex justify-between px-5 hover:bg-transparent">
                      ...
                      <TableCell class="text-foreground text-center w-2/3 sm:w-1/2 flex items-center justify-end">
                        ...
                        <div v-else
                          ...
                          <input :type="showOldPassword ? 'text' : 'password'" v-model="userPassword.oldPassword"
                    ...
                    <TableRow v-if="managePasswordEdit" class="flex justify-between px-5 hover:bg-transparent">
                      ...
                      <TableCell class="text-foreground text-center w-2/3 sm:w-1/2 flex items-center justify-end">
                        <div
                          ...
                          <input :type="showNewPassword ? 'text' : 'password'" v-model="userPassword.newPassword"
                      ...
                      <TableCell class="text-foreground text-center  w-2/3 sm:w-1/2 flex items-center justify-end">
                        <div
                          ...
                          <input :type="showConfirmPassword ? 'text' : 'password'"
                            v-model="userPassword.confirmPassword" class="text-right w-full focus:outline-none px-3"
