    ...
    <Dialog v-model:open="props.open" @update:open="handleOpenChange">
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription>
                    <div class="w-full flex flex-col justify-center items-center">
                        <div class="text-4xl text-[#242629] font-bold mt-2">Account Register</div>
                    </div>
                </DialogDescription>
            </DialogHeader>
            <div class="px-8 flex flex-col items-center justify-center pt-4">
                <div class="w-full flex flex-col gap-8">
                    ...
                    <div class="flex flex-col gap-1">
                        <label for="confirmpassword" class="text-xl px-4">Confirm Password</label>
                        <input placeholder="••••••••" id="confirmpassword" type="password"
                            class="px-4 py-3 text-lg border border-gray-500 rounded-md focus:outline-[#F8C600]" />
                    </div>
                </div>
                <button
                    class="bg-[#ECB211] text-[#242629] w-full py-4 mt-8 rounded-lg text-xl font-bold active:brightness-90 hover:brightness-95 cursor-pointer hover:shadow-md hover:shadow-[#aa8700]/30 transition-all duration-300">
                    REGISTER
                </button>
                <div class="w-full py-4 flex justify-center">
                    <span class="text-[#242629] text-lg font-light"> Already Have an Account? </span>
                    &nbsp;
                            <button @click="openLoginDialog" class="text-[#C08F06] text-lg font-light hover:underline hover:brightness-80">Login
                                Here!</button>
                </div>
